...
func NewGateway(addr string, st ServerType, sd client.ServiceDiscovery,
	failMode client.FailMode,
	selectMode client.SelectMode,
	option client.Option) *Gateway {
...
func (g *Gateway) handleRequest(w http.ResponseWriter,
	r *http.Request,
...
func getXClient(g *Gateway, servicePath string) (xc client.XClient, err error) {
	...
	if g.xclients[servicePath] == nil {
		g.xclients[servicePath] = client.NewXClient(servicePath, g.FailMode,
			g.SelectMode, g.serviceDiscovery.Clone(servicePath), g.Option)
	}
